...
--
-- Table structure for table `tab_penjualan`
--
...
--
-- Dumping data for table `tab_penjualan`
--

INSERT INTO `tab_penjualan` (`ID`, `id_produk`, `jumlah_bayar`) VALUES
(6, 6, 20000),
(7, 9, 20000),
(8, 8, 300000);
...
--
-- Indexes for table `tab_penjualan`
--
...
--
-- AUTO_INCREMENT for table `tab_penjualan`
--
ALTER TABLE `tab_penjualan`
...
--
-- Constraints for table `tab_penjualan`
--
ALTER TABLE `tab_penjualan`
